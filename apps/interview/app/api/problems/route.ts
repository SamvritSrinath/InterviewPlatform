...
import {createProblemSchema} from '@interview-platform/utils';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const problemData: Database['public']['Tables']['problems']['Insert'] = {
      ...
      wrong_answer: validatedData.wrong_answer || null,
      wrong_answer_explanation: validatedData.wrong_answer_explanation || null,
